        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-black/70 text-lg leading-relaxed mb-8">
              Connect with elite consultants who bring years of expertise and
              proven track records. Our vetted professionals are ready to take
              ...
              <div className="mb-6">
                <div className="flex flex-wrap gap-2">
                  {consultant.skills.map((skill, index) => (
                    <span
                      key={index}
                      className={`text-xs px-3 py-1 rounded-full ${getSkillStyle(
                        skill.type
                      )}`}
                    >
                      {skill.name}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 text-black/80">
                  ...
                  <span className="text-sm">
                    Member Since {consultant.stats.memberSince}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-3 text-black/80">
                  ...
                  <span className="text-sm">
                    Speaks {consultant.stats.languages.join(", ")}
                  </span>
                </div>
              </div>
